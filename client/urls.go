...
const (
	...
	USERS_INFO_URL                   = `/api/users/id/%d`
	USERS_LOCK_URL                   = `/api/users/id/%d/lock`
	USERS_LOCKED_URL                 = `/api/users/id/%d/locked`
	USERS_PREFS_URL                  = `/api/users/id/%d/preferences`
	USERS_ADMIN_URL                  = `/api/users/id/%d/admin`
	USERS_ADMIN_SU_PATH              = `/api/users/id/%d/su`
	USER_SESSIONS_URL                = `/api/users/id/%d/sessions`
	CHANGE_PASS_URL                  = `/api/users/id/%d/pwd`
	USERS_GROUP_URL                  = `/api/users/id/%d/group`
	USERS_GROUP_ID_URL               = `/api/users/id/%d/group/%d`
	USERS_MFA_CLEAR_URL              = `/api/users/id/%d/mfa/clear`
	WS_STAT_URL                      = `/api/ws/stats`
	WS_SEARCH_URL                    = `/api/ws/search`
	WS_ATTACH_URL                    = `/api/ws/attach/%s`
	PARSE_URL                        = `/api/parse`
	API_VERSION_URL                  = `/api/version`
	GROUP_ID_URL                     = `/api/groups/id/%d`
	GROUP_MEMBERS_URL                = `/api/groups/id/%d/members`
	GROUP_URL                        = `/api/groups`
	GROUP_LIST_URL                   = `/api/groups/list`
	SEARCH_PARSE_URL                 = `/api/parse`
	SEARCH_CTRL_LIST_URL             = `/api/searchctrl/list`
	SEARCH_CTRL_URL                  = `/api/searchctrl/id/%s`
	SEARCH_CTRL_ACCESS_URL           = `/api/searchctrl/id/%s/access`
	SEARCH_CTRL_ATTACH_URL           = `/api/searchctrl/id/%s/attach`
	SEARCH_CTRL_AX_SUGGESTIONS       = `/api/searchctrl/id/%s/extractor-suggestions`
	SEARCH_CTRL_BACKGROUND_URL       = `/api/searchctrl/id/%s/background`
	SEARCH_CTRL_SAVE_URL             = `/api/searchctrl/id/%s/save`
	SEARCH_CTRL_STOP_URL             = `/api/searchctrl/id/%s/stop`
	SEARCH_CTRL_DOWNLOAD_URL         = `/api/searchctrl/id/%s/download`
	SEARCH_CTRL_PING_URL             = `/api/searchctrl/id/%s/ping`
	SEARCH_CTRL_DETACH_URL           = `/api/searchctrl/id/%s/detach`
	SEARCH_CTRL_MODULES              = `/api/searchctrl/id/%s/modules`
	SEARCH_CTRL_STATS_URL            = `/api/searchctrl/id/%s/stats`
	SEARCH_CTRL_STATS_METADATA_URL   = `/api/searchctrl/id/%s/stats/metadata`
	SEARCH_CTRL_EXPLORE_URL          = `/api/searchctrl/id/%s/renderer/%s/explore`
	SEARCH_CTRL_ENTRIES_URL          = `/api/searchctrl/id/%s/renderer/%s`
	...
	RESOURCES_ID_URL                 = "/api/resources/id/%s"
	RESOURCES_ID_RAW_URL             = "/api/resources/id/%s/raw"
	RESOURCES_ID_CLONE_URL           = "/api/resources/id/%s/clone"
	...
	SCHEDULED_SEARCH_ID_URL          = "/api/scheduledsearches/id/%s"
	SCHEDULED_SEARCH_RESULTS_ID_URL  = "/api/scheduledsearches/id/%s/results"
	SCHEDULED_SEARCH_DEBUG_ID_URL    = "/api/scheduledsearches/id/%s/debug"
	SCHEDULED_SEARCH_CANCEL_ID_URL   = "/api/scheduledsearches/id/%s/cancel"
	...
	SCHEDULED_SCRIPT_ID_URL          = "/api/scheduledscripts/id/%s"
	SCHEDULED_SCRIPT_RESULTS_ID_URL  = "/api/scheduledscripts/id/%s/results"
	SCHEDULED_SCRIPT_DEBUG_ID_URL    = "/api/scheduledscripts/id/%s/debug"
	SCHEDULED_SCRIPT_CANCEL_ID_URL   = "/api/scheduledscripts/id/%s/cancel"
	...
	FLOW_ID_URL                      = "/api/flows/id/%v"
	FLOW_RESULTS_ID_URL              = "/api/flows/id/%s/results"
	FLOW_DEBUG_ID_URL                = "/api/flows/id/%s/debug"
	FLOW_CANCEL_ID_URL               = "/api/flows/id/%s/cancel"
	...
	KIT_ID_URL                       = `/api/kits/id/%s`
	KIT_BUILD_URL                    = `/api/kits/build`
	KIT_BUILD_ID_URL                 = `/api/kits/build/id/%s`
	...
	KIT_BUILD_HISTORY_ID_URL         = `/api/kits/build/history/id/%s`
	...
	EXTRACTORS_ID_URL                = `/api/autoextractors/id/%s`
	...
	TEMPLATES_ID_URL                 = "/api/templates/id/%s"
	TEMPLATES_ID_DETAILS_URL         = "/api/templates/id/%s/details"
	ACTIONABLES_URL                  = "/api/actionables"
	ACTIONABLES_LIST_URL             = "/api/actionables/list"
	ACTIONABLES_ID_URL               = "/api/actionables/id/%s"
	FILES_URL                        = "/api/files"
	FILES_LIST_URL                   = "/api/files/list"
	FILES_ID_URL                     = "/api/files/id/%s"
	FILES_ID_RAW_URL                 = "/api/files/id/%s/raw"
	LIBRARY_URL                      = "/api/library"
	LIBRARY_ID_URL                   = "/api/library/id/%s"
	...
	CAPABILITY_USER_URL              = `/api/users/id/%d/capabilities`
	CAPABILITY_USER_WHY_URL          = `/api/users/id/%d/capabilities/why`
	CAPABILITY_GROUP_URL             = `/api/groups/id/%d/capabilities`
	GROUP_TAG_ACCESS_URL             = `/api/groups/id/%d/tags`
	USER_TAG_ACCESS_URL              = `/api/users/id/%d/tags`
	PLAYBOOKS_URL                    = `/api/playbooks`
	PLAYBOOKS_LIST_URL               = `/api/playbooks/list`
	PLAYBOOKS_ID_URL                 = `/api/playbooks/id/%s`
	BACKUP_URL                       = `/api/backup`
	DEPLOYMENT_URL                   = `/api/deployment`
	TOKENS_URL                       = `/api/tokens`
	TOKENS_LIST_URL                  = `/api/tokens/list`
	TOKENS_ID_URL                    = `/api/tokens/id/%s`
	TOKENS_ID_REGEN_URL              = `/api/tokens/id/%s/regenerate`
	TOKENS_CAPABILITIES_URL          = `/api/tokens/capabilities`
	SECRETS_URL                      = `/api/secrets`
	SECRETS_LIST_URL                 = `/api/secrets/list`
	SECRETS_ID_URL                   = `/api/secrets/id/%s`
	SECRETS_ID_VALUE_URL             = `/api/secrets/id/%s/value`
	SECRETS_ID_FULL_URL              = `/api/secrets/id/%s/full`
	SETTINGS_URL                     = `/api/settings`
	INGESTERS_TRACKING_URL           = `/api/ingesters/%s/tracking`
	ALERTS_URL                       = `/api/alerts`
	ALERTS_LIST_URL                  = `/api/alerts/list`
	ALERTS_ID_URL                    = `/api/alerts/id/%s`
	ALERTS_ID_SAMPLE_URL             = `/api/alerts/id/%s/sample`
	...
	USER_PREFERENCES_ID_URL          = `/api/userpreferences/id/%s`
	LIST_URL                         = `/api/list`
